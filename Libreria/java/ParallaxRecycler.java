...
import com.joseluis.eltenedorlayout.adapters.RestaurantAdapter;
...
public class ParallaxRecycler extends RecyclerView {
    ...
    private void configureEffect(RecyclerView recyclerView, int dy){
        ...
        for (int i = firstVisible; i < (firstVisible + visibleCount); i++) {
            ...
            //obtenemos la imagen
            SquareImageView imgRestaurant = ((RestaurantAdapter.ViewHolder) recyclerView.getLayoutManager().findViewByPosition(i).getTag()).imgParallax;
